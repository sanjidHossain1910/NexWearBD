...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-lg border bg-card dark:bg-card-foreground dark:text-ellipsised dark:border-card-foreground dark:text-white shadow-sm", className)} {...props} />);
